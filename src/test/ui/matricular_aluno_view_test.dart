    ...
    Widget criarAmbienteDeTeste() {
      return ProviderScope(
        overrides: [
          ...
          // ignore: scoped_providers_should_specify_dependencies
          pesquisaAlunoProvider.overrideWith(
            () => FakePesquisaAlunoNotifier([alunoElegivelMock]),
          ),
        ],
        child: MaterialApp(home: MatricularAlunoView(turma: turmaMock)),
      );
    }

    testWidgets(
      'Deve renderizar, listar aluno elegivel e confirmar matricula com sucesso',
      (WidgetTester tester) async {
        when(
          mockAlunoService.atualizaAluno(any, any),
        ...
        expect(
          find.text('Carlos Silva matriculado com sucesso!'),
          findsOneWidget,
        );
      },
    );
