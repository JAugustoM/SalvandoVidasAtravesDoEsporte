...
class AppColors {
  ...
  // ── Primárias ──────────────────────────────────────────────────────────────
  static const Color royalAzure = Color(
    0xFF245BE6,
  ); // Azul principal, botões, seleção
  static const Color deepNavy = Color(
    0xFF001B5F,
  ); // Azul escuro, tooltips, headers
  static const Color cyanPrimary = Color(
    0xFF3FB0C5,
  ); // Azul clarinho, topbar, acentos
  static const Color cyanPastel = Color(
    0xFF9EBAFF,
  ); // Azul pastel, fundos suaves
  ...
  static List<BoxShadow> cardShadow(bool isDark) => [
    BoxShadow(
      color: royalAzure.withValues(alpha: isDark ? 0.35 : 0.18),
      blurRadius: 16,
      spreadRadius: 1,
